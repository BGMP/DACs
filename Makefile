...
testaccess:   basics.o bitrankw32int.o dacs.o
	$(CC) $(CFLAGS) basics.o bitrankw32int.o dacs.o -o testaccess $(SRCDIR)/testaccess.c  

testdecompress:   basics.o bitrankw32int.o dacs.o
	$(CC) $(CFLAGS) basics.o bitrankw32int.o dacs.o -o testdecompress $(SRCDIR)/testdecompress.c  
